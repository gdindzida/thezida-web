...
// include: C:\Users\Martin\AppData\Local\Temp\tmp4aayhdl_.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '../../../bin/app2.data';
      var REMOTE_PACKAGE_BASE = 'app2.data';
...
Module['FS_createPath']("/C:/Users", "Martin", true, true);
Module['FS_createPath']("/C:/Users/Martin", "git", true, true);
Module['FS_createPath']("/C:/Users/Martin/git", "LittleTriangleCollider", true, true);
Module['FS_createPath']("/C:/Users/Martin/git/LittleTriangleCollider", "shaders", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_../../../bin/app2.data');

      };
      Module['addRunDependency']('datafile_../../../bin/app2.data');
    ...
    loadPackage({"files": [{"filename": "C:/Users/Martin/git/LittleTriangleCollider/shaders/circle.frag", "start": 0, "end": 251}, {"filename": "C:/Users/Martin/git/LittleTriangleCollider/shaders/line.vert", "start": 251, "end": 458}, {"filename": "C:/Users/Martin/git/LittleTriangleCollider/shaders/point.vert", "start": 458, "end": 730}, {"filename": "C:/Users/Martin/git/LittleTriangleCollider/shaders/red.frag", "start": 730, "end": 881}], "remote_package_size": 881});

  })();

// end include: C:\Users\Martin\AppData\Local\Temp\tmp4aayhdl_.js
// include: C:\Users\Martin\AppData\Local\Temp\tmp3ja00jtq.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\Martin\AppData\Local\Temp\tmp3ja00jtq.js
// include: C:\Users\Martin\AppData\Local\Temp\tmpet8srnhp.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\Martin\AppData\Local\Temp\tmpet8srnhp.js
...
var _handleResetWrapper = Module['_handleResetWrapper'] = createExportWrapper('handleResetWrapper', 0);
var _handleUndoWrapper = Module['_handleUndoWrapper'] = createExportWrapper('handleUndoWrapper', 0);
var _handleConfigWrapper = Module['_handleConfigWrapper'] = createExportWrapper('handleConfigWrapper', 0);
var _handlePrWrapper = Module['_handlePrWrapper'] = createExportWrapper('handlePrWrapper', 0);
